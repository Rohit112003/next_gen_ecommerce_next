...
export default function Home() {
  return (
   <div className="bg-slate-50">
    <section>
      <MaxWidthWraperr className="pb-24 pt-10 lg:grid lg:grid-cols-3 sm:pb-32 lg:gap-x-0 xl:gap-x-8 lg:pt-24 xl:pt-32 lg:pb-52 ">
          ...
          <div className="relative max-auto text-center lg:text-left flex flex-col items-center lg:items-start ">
            ...
            <ul className='mt-8 space-y-2 text-left font-medium flex flex-col items-center sm:items-start'>
                <div className='space-y-2'>
                  ...
                  <li className='flex gap-1.5 items-center text-left'>
                    <CheckIcon className='h-5 w-5 shrink-0 text-green-600' />5 year
                    print guarantee
                  </li>
                  <li className='flex gap-1.5 items-center text-left'>
                    <CheckIcon className='h-5 w-5 shrink-0 text-green-600' />
    ...
    <section className="bg-slate-100 py-24">
      <MaxWidthWraperr className='flex flex-col items-center
      gap-16 sm:gap-32'>
        ...
        {/* second user  */}
          <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20 ">
            ...
            <div className="text-lg leading-8">
              <p>"I usually keep my phone together with my keys in my pocket and that led to some preety heavy scratchmarks on all of my last phone case . This one , besides a barely noticeable scratch on the corner, <span className="p-0.5 bg-slate-800 text-white ">Looks brand new after about half a year</span>  . I dig it . "</p>
            </div>
            <div className="flex gap-4 mt-2">
    ...
    <section>
        <MaxWidthWraperr className='py-24'>
          ...
          <ul className='mx-auto mt-12 max-w-prose sm:text-lg space-y-2 w-fit'>
            ...
            <li className='w-fit'>
              <CheckIcon className='h-5 w-5 text-green-600 inline mr-1.5' />5 year
              print warranty
            </li>
